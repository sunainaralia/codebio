...
function WhatWeDoSection() {
  ...
  return (
    <div className="py-[34px] 2xl:pt-28 flex flex-col justify-center md:items-center md:text-center px-[30px] md:px-0">
      ...
      <p className="text-[#2B2B2B] text-lg  md:text-lg 4xl:text-[30px] 4xl:leading-10 font-normal hidden md:block  lg:mt-[65px] mt-[50px]">
      ...
      <p className="text-[#2B2B2B] text-lg md:text-lg 4xl:text-[30px] 4xl:leading-10 font-normal hidden md:block mt-10 ">
