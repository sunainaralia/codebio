...
function OurApproachSection() {
  ...
  return (
    <div className='lg:flex justify-center flex-col md:flex-row pt-[30px] pb-14 md:py-14 lg:mt-44 lg:pt-28 3xl:gap-7 gap-4 3xl:h-[900px]'>
      <div className='h-full w-full flex flex-col justify-center items-start col-span-1 gap-2 md:gap-4 '>
        <div className='text-lg font-normal text-[#525252] sm:text-3xl lg:text-[28px] 3xl:text-[42px]'>
          Our Approach
        </div>
        <h1 className=' text-[34px] md:text-6xl lg:text-[50px] 3xl:text-[84px]  md:!leading-[5rem] 3xl:!leading-[7rem] font-[900]'>
        Build. Innovate. Grow.
        </h1>
        ...
        <p className='text-[15px] md:text-[20px] 3xl:text-3xl text-center lg:text-start text-[#2B2B2B]'>
