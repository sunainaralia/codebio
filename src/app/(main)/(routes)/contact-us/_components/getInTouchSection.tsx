...
const GetInTouchSection = () => {
  ...
  return (
    <div className='3xl:mt-[300px] lg:mt-[120px] md:mt-[80px] mt-[30px]  3xl:mb-[350px] lg:mb-[130px] mb-[85px]'>
      <div className=' mx-auto text-center text-3xl lg:text-[50px] 3xl:text-[72px] pt-2 font-bold mb-1 lg:mb-5'>
        Get In Touch
      </div>
      <Separator className='h-px w-full max-w-[100px] bg-[#525252] mx-auto' />
      ...
      <div className='flex flex-wrap justify-between 2xl:w-[90%] 4xl:w-[80%] mx-auto 4xl:mt-[150px] lg:mt-[90px] mt-[50px]'>
        <div className='flex max-md:w-full md:block md:text-center text-[#2b2b2b] justify-between'>
          ...
          <Separator
            className='h-px w-full max-w-[50px] bg-[#525252] my-5 mx-auto hidden md:block'
          />
        ...
        <Separator className='h-px md:h-auto w-full md:w-px bg-[#525252]  md:my-0 my-5' />
        <div className='flex max-md:w-full md:block md:text-center text-[#2b2b2b] justify-between'>
           <div>
        ...
        <div className='flex max-md:w-full md:block md:text-center text-[#2b2b2b] justify-between items-center'>
          <div className='font-black text-[24px] 3xl:text-[48px] xl:text-[35px] text-[#000]'>Work Enquires</div>
