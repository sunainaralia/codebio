  ...
  return (
    <div className='my-0 mb-10 py-0 md:mb-20 4xl:mt-30 xl:py-24  xl:min-h-[200px]  xl:grid grid-cols-5'>
      ...
      <div className='flex'>
        ...
        <Separator className='hidden xl:block h-full w-px bg-[#525252] p-[.5px] my-4' />
      </div>
      <Separator className='block xl:hidden h-full w-px bg-[#525252] p-[.5px] my-4' />
      <div className='flex'>
      ...
      <div className=' hidden xl:flex flex-col justify-end items-end col-span-2'>
        ...
        <Separator className='h-px w-full bg-[#525252] 4xl:my-4' />
...
function StatsInfo({ count, title }: { count: number; title: string }) {
  ...
  return (
    ...
    >
      ...
      <Separator className='hidden xl:block h-px w-full bg-[#525252] p-[.5px] my-4' />
      <h3 className='xl:p-4 xl:text-center xl:h-[3rem] text-base sm:text-xl 4xl:text-3xl font-normal text-[#2B2B2B]'>{title}</h3>
      <Separator className='block xl:hidden h-px w-full bg-[#525252] p-[.5px] my-4' />
    </div>
  );
}
