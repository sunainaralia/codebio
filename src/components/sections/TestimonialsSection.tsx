  ...
  return (
    <div id="testimonials" className="pb-10  lg:flex flex-col ">
      <div className="lg:flex flex-row justify-between  mb-10 items-center">
        <div className="flex gap-4 items-center lg:mx-[32px] mx-0">
          <Image
            alt=""
      ...
      <div className="py-8 pt-1">
        <div className="flex flex-row lg:justify-end items-center gap-6 scale-75 2xl:translate-y-14 lg:mb-5 2xl:mb-0 relative z-10">
          <ArrowIconButton
            height={70}
            width={70}
            onClick={handlePrev}
